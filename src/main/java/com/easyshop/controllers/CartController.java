...
public class CartController {
	...
	public void removeCartItem(HttpServletRequest req, HttpServletResponse res) throws IOException {
		
		
		//this is add functionality. change to remove funcitonality.
		objectMapper.configure(Feature.AUTO_CLOSE_SOURCE, true);
		...
		if(req.getMethod().equals("POST")) {
			...
			if(cartService.removeFromCart(cart)) { //if removeFromCart method returns true (indicating successful remove)
				res.setStatus(200);
